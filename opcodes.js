...
function OP_0nnn(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - SYS addr`);
}

// CLS
// Clear the display.
function OP_00E0(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - 00E0 - CLS`);
...
function OP_00EE(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - 00EE - RET`);
    PC = stack[--SP];
}
...
function OP_1nnn(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - JP addr`);
    PC = opcode & 0x0FFF;
}
...
function OP_2nnn(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - CALL addr`);
    stack[SP++] = PC;
    PC = opcode & 0x0FFF;
}
...
function OP_6xkk(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - LD Vx, byte`);
...
function OP_7xkk(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - ADD Vx, byte`);
    V[(opcode & 0x0F00) >> 8] += opcode & 0x00FF;
}
...
function OP_Annn(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - LD I, addr`);
    I = opcode & 0x0FFF;
}
...
function OP_Bnnn(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - JP V0, addr`);
...
function OP_Cxkk(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - RND Vx, byte`);
...
function OP_Dxyn(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - DRW Vx, Vy, nibble`);
    ...
    for (let i = 0; i < n; i++) {
        ...
        for (let j = 0; j < 8; j++) {
            if ((sprite & (0x80 >> j)) != 0) {
                const location = ((y + i) * width + (x + j));
                video[location] ^= 1;
                if (!video[location]) V[0xF] = 1;
            }
        }
    }
    needDrawing = true;
...
function OP_Ex9E(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - SKP Vx`);
...
function OP_ExA1(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - SKNP Vx`);
    if (keyboard[V[(opcode & 0x0F00) >> 8]] !== 0x1) {
        PC += 2;
    } else {
        keyboard.fill(0);
...
function OP_Fx07(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - LD Vx, DT`);
...
function OP_Fx0A(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - LD Vx, K`);
...
function OP_Fx15(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - LD DT, Vx`);
...
function OP_Fx18(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - LD ST, Vx`);
...
function OP_Fx1E(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - ADD I, Vx`);
...
function OP_Fx29(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - LD F, Vx`);
...
function OP_Fx33(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - LD B, Vx`);
...
function OP_Fx55(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - LD [I], Vx`);
...
function OP_Fx65(opcode) {
    if (debug) console.log((PC-2).toString(16).padStart(3,'0').toUpperCase() + ' - ', numberToHexString(opcode), ` - LD Vx, [I]`);
    for (let i = 0; i <= ((opcode & 0x0F00) >> 8); i++)
        V[i] = memory[I + i];
}
